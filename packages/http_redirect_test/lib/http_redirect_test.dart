  ...
  group('http_redirect_test', () {
    ...
    test('defaultStatusCode', () async {
      ...
      var response = await httpClientSend(
        client,
        httpMethodGet,
        Uri.parse('$clientUri?statusCode=none'),
      );
    ...
    test('success', () async {
      var response = await httpClientSend(
        client,
        httpMethodGet,
        Uri.parse('$clientUri?statusCode=200'),
      );
      expect(response.isSuccessful, isTrue);
    ...
    test(
      ...
      () async {
        var response = await httpClientSend(
          client,
          httpMethodGet,
          Uri.parse('$clientUri?statusCode=400'),
        );
    ...
    test('path', () async {
      ...
      expect(response.isSuccessful, isTrue);
      expect(
        Uri.parse(response.headers['x-echo-request-uri']!).path,
        endsWith('/some/path'),
      );
    });
